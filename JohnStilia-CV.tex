...
\begin{cvtable}[2]
	...
	\cvitem{}{LazyLogs VSCode Extension}{JS}{Easy print() and console.log() with one key combo}
	\cvitem{}{yoloCommit VSCode Extension}{JS}{Quick commit when you need to push fast}
...
\begin{cvtable}[1.5]
	\cvitem{6/2023 - Present}{Senior DevOps Engineer}{Century Tech}
		{
	...
	\cvitem{06/2022 - 06/2023}{DevSecOps Lead Engineer/Deputy Head of DevOps}{ITV/PlanetV}
		{
	...
	\cvitem{09/2021-06/2022}{Senior DevSecOps Engineer}{Sky Media}
		{
	...
	\cvitem{06/2020-09/2021}{DevSecOps Engineer}{Sky Media}
		{
	...
	\cvitem{2/2019-06/2020}{DevSecOps Engineer}{F-Secure}
		{
  }

  	\cvitem{09/2018-02/2019}{Support Engineer}{F-Secure}
		{
  }
