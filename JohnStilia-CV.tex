...
\begin{twenty}
  \twentyitem
    ...
    Developing processes and procedurs to comply with Audit and Security requirements.\\
  ...
  \twentyitem
    ...
    {DevSecOps Engineer}
    {Sky}
    {    Imrpve the AWS infrastructure\\
    Developing internal software to accomodate custom security needs.\\
    Developing and maintaining internal tools to improve the security of the platform.\\
    Support on the team's recruitment and onboarding process.
    }
  \twentyitem
    {02/2019-06/2020}
    {DevOps Engineer}
